    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      ...
      <div class="demo-drawer mdl-layout__drawer mdl-color--light-blue-900 mdl-color-text--blue-grey-50">
        ...
        <nav class="demo-navigation mdl-navigation mdl-color--blue-grey-800">
          ...
          <a class="mdl-navigation__link" href="/?page="><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">report</i>Lelang yang Dilaksanakan</a>
          <a class="mdl-navigation__link" href="/?page="><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">forum</i>Lelang Ulang</a>
          <a class="mdl-navigation__link" href="/?page="><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">flag</i>Pemenang Berdasarkan Lokasi</a>
